...
if __name__ == '__main__':
    ...
    parser.add_argument('--z1-enc', metavar='z1-enc', type=int, default=50, help='The encoder size for z1')
    parser.add_argument('--z2-enc', metavar='z2-enc', type=int, default=50, help='The encoder size for z2')
    parser.add_argument('--z1-dec', metavar='z1-dec', type=int, default=100, help='The decoder size for z1')
    parser.add_argument('--z2-dec', metavar='z2-dec', type=int, default=100, help='The decoder size for z2')
