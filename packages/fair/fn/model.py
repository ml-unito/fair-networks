...
class Model:
    ...
    def _build(self, options, optimizer):
        ...
        with tf.name_scope("s_loss"):
            ...
            self.s_train_loss_stat_start = tf.summary.scalar("s_train_softmax_loss_start", self.s_loss)
            self.s_test_loss_stat_start = tf.summary.scalar("s_test_softmax_loss_start", self.s_loss)
            self.s_train_loss_stat_end = tf.summary.scalar("s_train_softmax_loss_end", self.s_loss)
            self.s_test_loss_stat_end = tf.summary.scalar("s_test_softmax_loss_end", self.s_loss)
        ...
        with tf.name_scope("h_loss"):
            ...
            self.h_test_loss_stat = tf.summary.scalar("test_total_loss", self.h_loss)
        ...
        with tf.name_scope("s_accuracy"):
            ...
            self.s_train_accuracy_stat_start = tf.summary.scalar("s_train_accuracy_start", self.s_accuracy)
            self.s_test_accuracy_stat_start = tf.summary.scalar("s_test_accuracy_start", self.s_accuracy)
            self.s_train_accuracy_stat_end = tf.summary.scalar("s_train_accuracy_end", self.s_accuracy)
            self.s_test_accuracy_stat_end = tf.summary.scalar("s_test_accuracy_end", self.s_accuracy)
        ...
        self.h_train_step = optimizer.minimize(-self.s_loss, var_list=self.hidden_layers_variables)
        ...
        self.train_stats_s_start = tf.summary.merge([self.s_train_loss_stat_start, self.s_train_accuracy_stat_start])
        self.test_stats_s_start = tf.summary.merge([self.s_test_loss_stat_start, self.s_test_accuracy_stat_start])
        self.train_stats_s_end = tf.summary.merge([self.s_train_loss_stat_end, self.s_train_accuracy_stat_end])
        self.test_stats_s_end = tf.summary.merge([self.s_test_loss_stat_end, self.s_test_accuracy_stat_end])
        ...
        self.train_stats_h = tf.summary.merge([self.h_train_loss_stat])
        self.test_stats_h = tf.summary.merge([self.h_test_loss_stat])
        return self
